...
export const metadata: Metadata = {
  title: {
    default: "Camalote · Traé tus USDC a Solana",
    template: "%s · Camalote",
  },
  description:
    "¿Cuándo fue la última vez que usaste tus USDC? Mirar el saldo no cuenta. Traelos a Solana en un minuto, con tu email y sin letra chica.",
