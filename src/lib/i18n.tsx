...
const es = {
  ...
  landing: {
    ...
    statsTitle: "Números honestos",
    statsSub: "Salen directo de la cadena, no de una planilla. Hoy son chicos: todo por delante.",
...
const en: Dictionary = {
  ...
  landing: {
    ...
    statsTitle: "Honest numbers",
    statsSub: "Straight from the chain, not a spreadsheet. Small for now: everything ahead.",
