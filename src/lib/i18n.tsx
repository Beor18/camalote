...
const es = {
  ...
  landing: {
    ...
    statsTitle: "La plata cruza y queda a la vista.",
    statsSub: "Cada cruce se escribe en Solana. Estos números se actualizan solos y nadie los puede inflar, ni nosotros.",
...
const en: Dictionary = {
  ...
  landing: {
    ...
    statsTitle: "Money crosses, out in the open.",
    statsSub: "Every crossing is written on Solana. These numbers update on their own and nobody can inflate them, not even us.",
